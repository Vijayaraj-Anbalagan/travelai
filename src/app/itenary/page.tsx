  ...
  return (
    <div>
      ...
      <input
        type="number"
        name="no_of_days"
        value={userPreferences.no_of_days}
        onChange={handleInputChange}
      ...
      <input
        type="text"
        name="preferences.overall_trip"
        value={userPreferences.preferences.overall_trip}
        onChange={handleInputChange}
        placeholder="Overall trip"
      />
      <input
        type="text"
        name="transportation"
      ...
      <input
        type="checkbox"
        name="preferences.amusement_parks"
        checked={userPreferences.preferences.amusement_parks}
        onChange={handleInputChange}
      />
      <input
        type="checkbox"
        name="preferences.clubbing"
        checked={userPreferences.preferences.clubbing}
        onChange={handleInputChange}
      />
      <input
        type="checkbox"
        name="preferences.physical_activities"
        checked={userPreferences.preferences.physical_activities}
        onChange={handleInputChange}
      />
      <input
        type="checkbox"
        name="preferences.sightseeing"
        checked={userPreferences.preferences.sightseeing}
        onChange={handleInputChange}
      />
      <label>Activities</label>
      <input
